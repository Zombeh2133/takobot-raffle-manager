...
EMAIL_PASSWORD = os.environ.get("EMAIL_PASSWORD", "yntfjvfkwfscsxlx")  # Set your 16-char app password
EMAIL_FROM = os.environ.get("EMAIL_FROM", EMAIL_USER)
TEST_TO_EMAIL = "littlesharksaba@gmail.com"  # Change this to your test email
