...
EMAIL_USER = os.environ.get("EMAIL_USER", "ww2994@gmail.com")
...
async def proxy_background_polling():
    ...
    async with httpx.AsyncClient() as client:
        response = await client.get("http://localhost:3000/background-polling.js")
...
async def proxy_global_scan_indicator():
    ...
    async with httpx.AsyncClient() as client:
        response = await client.get("http://localhost:3000/global-scan-indicator.js")
        return Response(content=response.content, media_type="application/javascript")
...
async def proxy_sidebar_admin_control():
    ...
    async with httpx.AsyncClient() as client:
        response = await client.get("http://localhost:3000/sidebar-admin-control.js")
        return Response(content=response.content, media_type="application/javascript")
